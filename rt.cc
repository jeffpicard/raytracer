...
int main() {
    ...
    Plane *p1 = new Plane(0, Vector3F(0,1,0));
    p1->setSurfaceColor(Color(.5,0,.5));
    testScene.addObject(p1);

    Sphere *s1 = new Sphere(Vector3F(-1.2,.5,0), .5);
    s1->setSurfaceColor(Color(1,0,0));
    testScene.addObject(s1);

    Sphere *s2 = new Sphere(Vector3F(0,.5,0), .5);
    s2->setSurfaceColor(Color(0,1,0));
    testScene.addObject(s2);

    Sphere *s3 = new Sphere(Vector3F(1.2,.5,0), .5);
    s3->setSurfaceColor(Color(0,0,1));
    testScene.addObject(s3);


    Light *l1 = new Light(Vector3F(-10,10,5), Color(.8,.8,.8));
    testScene.addLight(l1);

    Light *l2 = new Light(Vector3F(5,3,5), Color(.3,.3,.3));
